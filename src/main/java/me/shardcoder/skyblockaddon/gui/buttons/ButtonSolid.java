...
public class ButtonSolid extends ButtonText {
     ...
     */
    public ButtonSolid( double x, double y, int width, int height, String buttonText, SkyblockAddon main, Feature feature) {
...
//        if (feature == Feature.ANCHOR_POINT) scale = 1;
        ...
        if (!originalString.equals(displayString) && mc.currentScreen instanceof SkyblockAddonGui) {
