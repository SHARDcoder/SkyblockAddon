package me.shardcoder.skyblockaddon.tweaker;
...
public class SkyblockAddonTweaker implements ITweaker {
    ...
    public void injectIntoClassLoader(LaunchClassLoader classLoader) {
        ...
        try {
            ...
            System.out.println("[SkyblockAddon] Did not find Mixins class/method, might be using an earlier version of mixins.");
        }
