...
public class EnumUtils {
    ...
    public enum AnchorPoint {
        ...
        HEALTH_BAR(4, Message.ANCHOR_POINT_HEALTH_BAR);
    ...
    public enum InventoryType {
        ENCHANTMENT_TABLE(Message.INVENTORY_TYPE_ENCHANTS),
        REFORGE_ANVIL(Message.INVENTORY_TYPE_REFORGES);
    ...
    public enum BackpackStyle {
        GUI(Message.BACKPACK_STYLE_GUI),
    ...
    public enum TextStyle {
        REGULAR(Message.TEXT_STYLE_REGULAR),
        BLACK_SHADOW(Message.TEXT_STYLE_BLACK_SHADOW);
