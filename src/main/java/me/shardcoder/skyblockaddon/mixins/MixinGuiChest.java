...
public abstract class MixinGuiChest extends GuiContainer {
    ...
    public void initGui() {
        ...
        if (inventoryType != null) {
            ...
            List<String> lockedEnchantments = SkyblockAddon.getInstance().getUtils().getEnchantmentMatch();
            ...
            lockedEnchantments = SkyblockAddon.getInstance().getUtils().getEnchantmentExclusion();
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        if (inventoryType != null) {
            ...
            if (textFieldMatch != null) {
                ...
                SkyblockAddon.getInstance().getUtils().setEnchantmentMatch(enchantments);
                enchantments = new LinkedList<>(Arrays.asList(textFieldExclusions.getText().split(",")));
                SkyblockAddon.getInstance().getUtils().setEnchantmentExclusion(enchantments);
            }
        } else {
            super.keyTyped(typedChar, keyCode);
        }
